...
START_TEST(s21_create_matrix1) {
  ...
  matrix_t matrix;
  ck_assert_int_eq(0, s21_create_matrix(rows, columns, &matrix));
...
START_TEST(s21_mult_number1) {
  ...
  ck_assert_int_eq(s21_mult_number(&matrix1, number, &result), 0);
  ck_assert_int_eq(s21_eq_matrix(&check, &result), SUCCESS);
  s21_remove_matrix(&matrix1);
  s21_remove_matrix(&result);
  s21_remove_matrix(&check);
...
START_TEST(s21_determinant1) {
  ...
  ck_assert_int_eq(0, s21_determinant(&matrix, &result));
...
//   ck_assert_int_eq(1, s21_determinant(&matrix, &result));
// }
// END_TEST
...
START_TEST(s21_determinant3) {
  ...
  ck_assert_int_eq(2, s21_determinant(&matrix, &result));
  s21_remove_matrix(&matrix);
}
END_TEST
...
START_TEST(s21_calc_complements2) {
  ...
  ck_assert_int_eq(s21_calc_complements(&matrix1, &matrix2), 2);
  s21_remove_matrix(&matrix1);
}
END_TEST
...
START_TEST(s21_calc_complements3) {
  ...
  ck_assert_int_eq(s21_calc_complements(&matrix1, &matrix2), 0);
  ck_assert_int_eq(s21_eq_matrix(&matrix1, &matrix2), FAILURE);
  s21_remove_matrix(&matrix1);
  s21_remove_matrix(&matrix2);
}
...
START_TEST(s21_calc_complements4) {
  ...
  matrix1.matrix[0][1] = 0.3;
  matrix1.matrix[0][2] = 2.3;
  matrix1.matrix[0][3] = -1;
  matrix1.matrix[0][4] = -0.4;
  matrix1.matrix[1][0] = 0.2;
  matrix1.matrix[1][1] = 4;
  matrix1.matrix[1][2] = 2;
  matrix1.matrix[1][3] = 6;
  matrix1.matrix[1][4] = 8;
  matrix1.matrix[2][0] = 9;
  matrix1.matrix[2][1] = -5;
  matrix1.matrix[2][2] = -0.5;
  matrix1.matrix[2][3] = 0.4;
  matrix1.matrix[2][4] = 0.6;
  matrix1.matrix[3][0] = 7;
  matrix1.matrix[3][1] = 2;
  matrix1.matrix[3][2] = 7;
  matrix1.matrix[3][3] = 2;
  matrix1.matrix[3][4] = 9;
  matrix1.matrix[4][0] = -3;
  matrix1.matrix[4][1] = -5;
  matrix1.matrix[4][2] = -1;
  matrix1.matrix[4][3] = 2;
  matrix1.matrix[4][4] = -2;
...
//   ck_assert_int_eq(s21_inverse_matrix(&matrix1, &matrix2), 1);
// }
// END_TEST
...
START_TEST(s21_inverse_matrix2) {
  matrix_t matrix1, matrix2;
  s21_create_matrix(1, 11, &matrix1);
  ck_assert_int_eq(s21_inverse_matrix(&matrix1, &matrix2), 2);
  s21_remove_matrix(&matrix1);
}
END_TEST
